                                    ...
                                    <div>
                                        ...
                                        <div role="presentation" class="dropdown">
                                            ...
                                            <ul class="dropdown-menu " role="menu" >
                                                <li><a href="/bugHandle?bugid=${bug.id}&method=delete" onclick="return confirm('确定删除?');">删除</a></li>
                    ...
                    <div class="panel-body">
                        <div>
                            <div class="form-group">
                                ...
                                <input class="form-control" id="bugid" type="text" name="selectbugid" placeholder="${modifyBug.id}" value="${modifyBug.id}" disabled>
                            </div>
                            <div class="form-group">
                                <label for="status" class="control-label">状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态</label>
                                <select class="form-control" id="status">
                                    <option value="待修改">待修改</option>
                                    <option selected="selected" value="${modifyBug.status}">${modifyBug.status}</option>
                            ...
                            <div class="form-group">
                                ...
                                <%--<label class="radio-inline">
                                    <input style="display:inline-block " type="radio" name="level" id="inlineRadio1" value="${modifyBug.level}" checked> ${modifyBug.level}
                                </label>--%>
                                <label class="radio-inline">
                                    <input style="display: inline-block" type="radio" name="level" id="inlineRadio2" value="低" checked> 高
                                </label>
                                <label class="radio-inline">
                                    <input style="display: inline-block" type="radio" name="level" id="inlineRadio3" value="中"> 中
                                </label>
                                <label class="radio-inline">
                                    <input style="display: inline-block" type="radio" name="level" id="inlineRadio4" value="低"> 低
                                </label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="worktime">
                                    ...
                                    <option selected="selected" value="${modifyBug.worktime}">${modifyBug.worktime}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="task" datatype="s5-16" placeholder="${modifyBug.taskName}" value="${modifyBug.taskName}">

                            </div>
                            <div class="form-group">
                                <label for="testDate">测试时间</label>
                                <input type="text" class="form-control" id="testDate" placeholder="${modifyBug.testDate}" value="${modifyBug.testDate}" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" >
                            </div>
                            <div class="form-group">
                                <label for="deadLine">预计完成时间</label>
                                <input type="text" class="form-control " id="deadLine" placeholder="${modifyBug.deadDate}" value="${modifyBug.deadDate}" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                            </div>
                            <div style="height: 20px"></div>
                            <button type="submit" class="btn btn-primary block full-width m-b" onclick="insert()">修改</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    function insert() {
        ...
        $.ajax({
            type:"post",
            url:"/bugHandle",
            data:{"bugid":bugid,"status":status,"level":level,"workTime":worktime,"taskName":taskName,"testdate":testdate,"deadtime":deadtime,"method":method},
            error:function () {
                alert("未知错误，请尝试");
